...
import getMarkCompiledContent from './src/config/compile-markdown';
...
const isPrivate = process.argv.splice(2)[0] === 'true'; // 是否私人模式
...
[
 ...
 './node_modules/highlight.js/lib/languages/sql.js'
  ...
  copyFileSync(path.resolve(__dirname, file), path.resolve(__dirname, './dist/static/js/highlight/'));  
});
